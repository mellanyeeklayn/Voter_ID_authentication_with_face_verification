...
def simxSetJointTargetVelocity(clientID, jointHandle, targetVelocity, operationMode) -> object:
    '''
    Please have a look at the function description/documentation in the CoppeliaSim user manual
    '''
...
def simxStartSimulation(clientID, operationMode) -> object:
    '''
    Please have a look at the function description/documentation in the CoppeliaSim user manual
    '''
...
def simxGetObjectFloatParameter(clientID, objectHandle, parameterID, operationMode):
    ...
    return c_GetObjectFloatParameter(clientID, objectHandle, parameterID, ct.byref(parameterValue), operationMode)
